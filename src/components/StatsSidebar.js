...
const StatsSidebar = () => {
  ...
  return (
    <div className="w-full h-screen bg-gray-900/80 backdrop-blur-sm border-l border-gray-700/50 p-6 flex-shrink-0 overflow-hidden shadow-lg">
      <div className="mb-6">
      ...
      <div className="mt-6">
        <button
          ...
          className="w-full bg-gray-700/50 hover:bg-gray-700/70 text-gray-200 py-3 px-4 rounded-full transition-colors duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isRefreshing ? (
            <>
